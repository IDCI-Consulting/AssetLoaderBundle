...
class TestsTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fake_asset_provider' => 'getFakeAssetProviderService',
            ...
            'idci_asset_loader.asset_dom_loader' => 'getIdciAssetLoader_AssetDomLoaderService',
            'idci_asset_loader.asset_dom_loader_event_listener' => 'getIdciAssetLoader_AssetDomLoaderEventListenerService',
            'idci_asset_loader.asset_provider.registry' => 'getIdciAssetLoader_AssetProvider_RegistryService',
            'idci_asset_loader.asset_renderer' => 'getIdciAssetLoader_AssetRendererService',
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => $this->get('kernel.class_cache.cache_warmer'), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this), 2 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, NULL, array(($this->targetDirs[2].'/templates') => 'twig_path')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($this->get('kernel'), $this->targetDirs[2], array(($this->targetDirs[2].'/templates') => 'twig_path')))));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.reponse', array(0 => 'idci_asset_loader.asset_dom_loader_event_listener', 1 => 'onKernelReponse'), 0);
    ...
    /**
     * Gets the 'fake_asset_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IDCI\Bundle\AssetLoaderBundle\Tests\FakeAssetProvider A IDCI\Bundle\AssetLoaderBundle\Tests\FakeAssetProvider instance
     */
    protected function getFakeAssetProviderService()
    {
        return $this->services['fake_asset_provider'] = new \IDCI\Bundle\AssetLoaderBundle\Tests\FakeAssetProvider();
    }
    ...
    /**
     * Gets the 'idci_asset_loader.asset_dom_loader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IDCI\Bundle\AssetLoaderBundle\AssetLoader\AssetDOMLoader A IDCI\Bundle\AssetLoaderBundle\AssetLoader\AssetDOMLoader instance
     */
    protected function getIdciAssetLoader_AssetDomLoaderService()
    {
        return $this->services['idci_asset_loader.asset_dom_loader'] = new \IDCI\Bundle\AssetLoaderBundle\AssetLoader\AssetDOMLoader($this->get('debug.event_dispatcher'), $this->get('idci_asset_loader.asset_renderer'), $this->get('idci_asset_loader.asset_provider.registry'));
    }

    /**
     * Gets the 'idci_asset_loader.asset_dom_loader_event_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IDCI\Bundle\AssetLoaderBundle\AssetLoader\AssetDOMLoaderEventListener A IDCI\Bundle\AssetLoaderBundle\AssetLoader\AssetDOMLoaderEventListener instance
     */
    protected function getIdciAssetLoader_AssetDomLoaderEventListenerService()
    {
        return $this->services['idci_asset_loader.asset_dom_loader_event_listener'] = new \IDCI\Bundle\AssetLoaderBundle\AssetLoader\AssetDOMLoaderEventListener($this->get('debug.event_dispatcher'), $this->get('idci_asset_loader.asset_renderer'), $this->get('idci_asset_loader.asset_provider.registry'));
    }

    /**
     * Gets the 'idci_asset_loader.asset_provider.registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IDCI\Bundle\AssetLoaderBundle\AssetProvider\AssetProviderRegistry A IDCI\Bundle\AssetLoaderBundle\AssetProvider\AssetProviderRegistry instance
     */
    protected function getIdciAssetLoader_AssetProvider_RegistryService()
    {
        $this->services['idci_asset_loader.asset_provider.registry'] = $instance = new \IDCI\Bundle\AssetLoaderBundle\AssetProvider\AssetProviderRegistry();

        $instance->set('fake_asset_provider', $this->get('fake_asset_provider'));

        return $instance;
    }

    /**
     * Gets the 'idci_asset_loader.asset_renderer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IDCI\Bundle\AssetLoaderBundle\AssetRenderer\AssetRenderer A IDCI\Bundle\AssetLoaderBundle\AssetRenderer\AssetRenderer instance
     */
    protected function getIdciAssetLoader_AssetRendererService()
    {
        return $this->services['idci_asset_loader.asset_renderer'] = new \IDCI\Bundle\AssetLoaderBundle\AssetRenderer\AssetRenderer($this->get('twig'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $d = new \Symfony\Bridge\Twig\Extension\HttpFoundationExtension($b, NULL);
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('paths' => array(($this->targetDirs[2].'/templates') => 'twig_path'), 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'debug' => true, 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Twig\Loader\FilesystemLoader A Twig\Loader\FilesystemLoader instance
     */
    protected function getTwig_LoaderService()
    {
        $this->services['twig.loader'] = $instance = new \Twig\Loader\FilesystemLoader(array());

        $instance->addPath(($this->targetDirs[2].'/templates'), 'twig_path');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IDCIAssetLoaderBundle' => 'IDCI\\Bundle\\AssetLoaderBundle\\IDCIAssetLoaderBundle',
            ),
            ...
            'idci_asset_loader.auto_load' => false,
